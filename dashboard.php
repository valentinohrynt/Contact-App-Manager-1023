...
<head>
    ...
    <title>Dashboard - Contact App Manager</title>
        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                            ...
                            <li>
                                <a href="#" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                                    <i class="fs-4 bi-journal-bookmark-fill"></i> <span
                                        class="ms-1 d-none d-sm-inline">Kontak</span> </a>
                            </li>
                        </ul>
                        <hr>
                ...
                <div class="col py-3 pt-5">
                    <div class="col-md">
                        <button class="btn btn-light btn-sm text-white border-0"
                            style="font-weight: 600; background-color:darkcyan;" data-bs-toggle="modal"
                    ...
                    <div class="col pt-5">
                        <div class="col-md">
                            <table id="dataContact"
                                class="list table table-striped table-responsive table-hover text-center"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                ...
                                <tbody>
                                    ...
                                    $contacts = $contactController->getAllContacts($userId);;
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#ubahData-<?php echo $contact['id']; ?>"><i
                                                    class="bi bi-pencil" style="color: black;"></i>
                                                Edit
                                            </button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteData-<?php echo $contact['id']; ?>"><i
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" style="color: black;"
                                id="ubahDataLabel-<?php echo $contact['id']; ?>">
                                Ubah data</h5>
                            <span aria-hidden="true">&times;</span>
                        </div>
                        <div class="modal-body">
                            <form action="controllers/contactcontroller.php?action=update" method="POST">
                                <input type="hidden" name="contactId" value="<?php echo $contact['id']; ?>">
                                <div class="form-group mb-3">
                                    <input type="text" class="form-control" name="contactName"
                                        value="<?php echo $contact['contact_name']; ?>" placeholder="Masukkan Nama">
                                </div>
                                <div class="form-group mb-3">
                                    <input type="tel" class="form-control" name="phone"
                                        value="<?php echo $contact['phone']; ?>" placeholder="Masukkan Nomor HP">
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="controllers/contactcontroller.php?action=delete" method="POST">
                                <input type="hidden" name="contactId" value="<?php echo $contact['id']; ?>">
            ...
            <div class="modal fade" id="tambahData" tabindex="-1" aria-labelledby="tambahDataLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="controllers/contactcontroller.php?action=add" method="post">
                            <div class="modal-body">
                                <div class="form-group mb-3">
